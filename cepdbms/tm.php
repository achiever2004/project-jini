...
<head>
    ...
    <link rel="stylesheet" href="tmstyles.css">
    <script src="./tmscript.js"></script>
</head>
...
<body>
    ...
    <div class="main-container" id="main">
        <div class="description-container">
            ...
            <div class="profile-section">
                ...
                <div class="profile-info-container">
                    <h3 class="name">Call me JINI</h3>
                    
                </div>
            </div>
            <div class="project-details-container">
                <div class="project-heading">
                    <h1 class="heading">Project JINI </h1>
                </div>
                <div class="project-description">
                    <p class="description">Jini can be your All-in-One Assistant, from answering questions to engaging in casual conversations</p>
                </div>
            </div>
        ...
        <div class="d-flex flex-column justify-content-center cbit_container">
            ...
            <script type="text/javascript">
                const URL = "https://teachablemachine.withgoogle.com/models/OFKY47OZM/";

                let model, webcam, labelContainer, maxPredictions;
                let dangerStartTime = 0;
                let sadnesstime = 0
                let isDangerAnnounced = false;
                let issadannounced = false;
                ...
                async function predict() {
                    ...
                    checkDanger(prediction[1].probability);
                    checkSadness(prediction[6].probability);
                }

                function checkDanger(probability) {
                    const currentTime = Date.now();
                    if (probability > 0.5) {
                        if (dangerStartTime === 0) {
                            dangerStartTime = currentTime;
                        } else if (currentTime - dangerStartTime > 10000 && !isDangerAnnounced) {
                            announceDanger();
                            isDangerAnnounced = true;
                        }
                    } else {
                        dangerStartTime = 0;
                        isDangerAnnounced = false;
                    }
                }

                function checkSadness(probability) {
                    const currentTime = Date.now();
                    if (probability > 0.5) {
                        if (sadnesstime === 0) {
                            sadnesstime = currentTime;
                        } else if (currentTime - sadnesstime > 10000 && !issadannounced) {
                            announceSad();
                            issadannounced = true;
                        }
                    } else {
                        sadnesstime = 0;
                        issadannounced = false;
                    }
                }

                function announceDanger() {
                    const msg = new SpeechSynthesisUtterance("You are using the phone for a long time common i have planned few intresting games we can play together");
                    window.speechSynthesis.speak(msg);
                }

                function announceSad() {
                    const msg = new SpeechSynthesisUtterance("You are looking so sad today, why can't you share it with your best friend!");
                    window.speechSynthesis.speak(msg);
                }
            </script>

            <div class="d-flex flex-row justify-content-center">
                <input type="text" placeholder="Enter your question" class="background_cbit" id="input_question" />
                <p id="error_message"></p>
                <button onclick="submitQuestion()"> Submit </button>
            </div>
            <p id="answer_element"></p>
        </div>
        <div class="footer-section footer-mobile">
            <div class="footer-info">
                <span class="heart-beat">❤</span> Built during AI workshop
            </div>
            <div class="divider-container">
                <div class="divider"></div>
            </div>

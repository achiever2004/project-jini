<!DOCTYPE html>
    ...
    <body>
        <img src="./logo-aruk.jpg" alt="aruk-logo" width="40px" height="40px">  
        <section class="neon bd-container">
            <div class="neon__container">
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">Task Manager</h1>
                    <p class="neon__description">Automating tasks without needing your input.</p>
                    <a href="./tasks.php" class="neon__button">Try 
                ...
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">3D Companion</h1>
                    <p class="neon__description">Personalized 3D avatars interact with their surroundings in a lifelike manner.</p>
                    <a href="./companion3d.php" class="neon__button">Show 
                            <path d="M24.0099 4C29.3698 4 33.7763 8.21182 34 13.5486H33.9477C33.954 13.7038 33.9242 13.8583 
                                33.8606 14H34.1729C36.6069 14 39.1557 15.687 40.1777 19.7596L40.2887 20.2401L41.8265 32.6295C42.9332 
                                40.5315 38.6099 43.8546 32.7124 43.9953L32.3169 44H15.7371C9.74355 44 5.12509 41.8159 6.14056 
                                33.1671L6.20981 32.6295L7.76528 20.2401C8.53228 15.8544 11.1072 14.1245 13.5882 14.0065L13.8634 
                ...
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">Smart Assistant</h1>
                    <p class="neon__description">Learns from your commands and provides results based on command optimization. It learns what we feed into it.</p>
                    <a href="./doctor_specialist.php" class="neon__button">Try 
                            <path d="M24.0099 4C29.3698 4 33.7763 8.21182 34 13.5486H33.9477C33.954 13.7038 33.9242 13.8583 
                                33.8606 14H34.1729C36.6069 14 39.1557 15.687 40.1777 19.7596L40.2887 20.2401L41.8265 32.6295C42.9332 
                                40.5315 38.6099 43.8546 32.7124 43.9953L32.3169 44H15.7371C9.74355 44 5.12509 41.8159 6.14056 
                                33.1671L6.20981 32.6295L7.76528 20.2401C8.53228 15.8544 11.1072 14.1245 13.5882 14.0065L13.8634 
                ...
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">Global Connectivity</h1>
                    <p class="neon__description">Jini is interconnected with all other active Jinis through an inter-chain connection.</p>
                    <a href="chat.php" class="neon__button">Check 
                            <path d="M24.0099 4C29.3698 4 33.7763 8.21182 34 13.5486H33.9477C33.954 13.7038 33.9242 13.8583 
                                33.8606 14H34.1729C36.6069 14 39.1557 15.687 40.1777 19.7596L40.2887 20.2401L41.8265 32.6295C42.9332 
                                40.5315 38.6099 43.8546 32.7124 43.9953L32.3169 44H15.7371C9.74355 44 5.12509 41.8159 6.14056 
                                33.1671L6.20981 32.6295L7.76528 20.2401C8.53228 15.8544 11.1072 14.1245 13.5882 14.0065L13.8634 
                ...
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">Teachable Machine</h1>
                    <p class="neon__description">We trained some models throungh Teachable machine</p>
                    <a href="./tm.php" class="neon__button">Try 
                            <path d="M24.0099 4C29.3698 4 33.7763 8.21182 34 13.5486H33.9477C33.954 13.7038 33.9242 13.8583 
                                33.8606 14H34.1729C36.6069 14 39.1557 15.687 40.1777 19.7596L40.2887 20.2401L41.8265 32.6295C42.9332 
                                40.5315 38.6099 43.8546 32.7124 43.9953L32.3169 44H15.7371C9.74355 44 5.12509 41.8159 6.14056 
                                33.1671L6.20981 32.6295L7.76528 20.2401C8.53228 15.8544 11.1072 14.1245 13.5882 14.0065L13.8634 
                ...
                <div class="neon__card">
                    ...
                    <h1 class="neon__title">Limited Access</h1>
                    <p class="neon__description">The database and functions vary based on the user's level.</p>
                    <a href="#" class="neon__button">Try 
                            <path d="M24.0099 4C29.3698 4 33.7763 8.21182 34 13.5486H33.9477C33.954 13.7038 33.9242 13.8583 
                                33.8606 14H34.1729C36.6069 14 39.1557 15.687 40.1777 19.7596L40.2887 20.2401L41.8265 32.6295C42.9332 
                                40.5315 38.6099 43.8546 32.7124 43.9953L32.3169 44H15.7371C9.74355 44 5.12509 41.8159 6.14056 
                                33.1671L6.20981 32.6295L7.76528 20.2401C8.53228 15.8544 11.1072 14.1245 13.5882 14.0065L13.8634 
                ...
                <a href="javascript:history.back()" class="neon__button">Go Back</a>
